...
public abstract class PaymentMethod<R extends PaymentRail> implements Comparable<PaymentMethod<R>>, NetworkProto {
    ...
    @Override
    public abstract bisq.account.protobuf.PaymentMethod toProto(boolean ignoreAnnotation);

    protected bisq.account.protobuf.PaymentMethod.Builder getPaymentMethodBuilder(boolean ignoreAnnotation) {
