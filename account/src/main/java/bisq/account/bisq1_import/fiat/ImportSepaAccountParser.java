...
@Slf4j
public final class ImportSepaAccountParser extends ImportCountryBasedAccountParser<FiatPaymentMethod, SepaAccountPayload> {

    public ImportSepaAccountParser(JsonNode accountNode) {
        super(accountNode);
    }

    @Override
    public SepaAccount parse(KeyPair dsaKeyPair) {
        ...
        SepaAccountPayload accountPayload = new SepaAccountPayload(
