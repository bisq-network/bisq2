...
@Slf4j
public final class ImportCashByMailAccountParser extends ImportFiatAccountParser<FiatPaymentMethod, CashByMailAccountPayload> {

    public ImportCashByMailAccountParser(JsonNode accountNode) {
        super(accountNode);
    }
