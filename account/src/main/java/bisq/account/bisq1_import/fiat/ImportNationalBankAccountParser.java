...
@Slf4j
public final class ImportNationalBankAccountParser extends ImportBankAccountParser<FiatPaymentMethod, NationalBankAccountPayload> {

    public ImportNationalBankAccountParser(JsonNode accountNode) {
        super(accountNode);
    }

    @Override
    public NationalBankAccount parse(KeyPair dsaKeyPair) {
        ...
        NationalBankAccountPayload accountPayload = new NationalBankAccountPayload(
