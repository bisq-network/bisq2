...
@Slf4j
public final class ImportZelleAccountParser extends ImportFiatAccountParser<FiatPaymentMethod, ZelleAccountPayload> {

    public ImportZelleAccountParser(JsonNode accountNode) {
        super(accountNode);
    }

    @Override
    public ZelleAccount parse(KeyPair dsaKeyPair) {
        ...
        ZelleAccountPayload accountPayload = new ZelleAccountPayload(
