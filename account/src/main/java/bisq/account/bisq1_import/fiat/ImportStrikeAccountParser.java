...
@Slf4j
public final class ImportStrikeAccountParser extends ImportCountryBasedAccountParser<FiatPaymentMethod, StrikeAccountPayload> {

    public ImportStrikeAccountParser(JsonNode accountNode) {
        super(accountNode);
    }

    @Override
    public StrikeAccount parse(KeyPair dsaKeyPair) {
        String holderName = requireText(paymentAccountPayloadNode, "holderName");
        StrikeAccountPayload accountPayload = new StrikeAccountPayload(
