...
@Slf4j
public final class ImportBizumAccountParser extends ImportCountryBasedAccountParser<FiatPaymentMethod, BizumAccountPayload> {

    public ImportBizumAccountParser(JsonNode accountNode) {
        super(accountNode);
    }

    @Override
    public BizumAccount parse(KeyPair dsaKeyPair) {
        String mobileNr = requireText(paymentAccountPayloadNode, "mobileNr");
        BizumAccountPayload accountPayload = new BizumAccountPayload(
