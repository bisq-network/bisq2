...
public final class VerseAccount extends Account<VerseAccountPayload, FiatPaymentMethod> {

    private static final FiatPaymentMethod PAYMENT_METHOD = FiatPaymentMethod.fromPaymentRail(FiatPaymentRail.VERSE);

    public VerseAccount(String accountName, VerseAccountPayload accountPayload) {
