...
public final class UpholdAccount extends Account<UpholdAccountPayload, FiatPaymentMethod> {

    private static final FiatPaymentMethod PAYMENT_METHOD = FiatPaymentMethod.fromPaymentRail(FiatPaymentRail.UPHOLD);

    public UpholdAccount(String accountName, UpholdAccountPayload accountPayload) {
