...
public final class WeChatPayAccount extends Account<WeChatPayAccountPayload, FiatPaymentMethod> {

    private static final FiatPaymentMethod PAYMENT_METHOD = FiatPaymentMethod.fromPaymentRail(FiatPaymentRail.WECHAT_PAY);

    public WeChatPayAccount(String accountName, WeChatPayAccountPayload accountPayload) {
