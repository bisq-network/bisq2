...
public final class USPostalMoneyOrderAccount extends CountryBasedAccount<USPostalMoneyOrderAccountPayload> {
    public USPostalMoneyOrderAccount(String id,
                                     long creationDate,
                                     String accountName,
                                     USPostalMoneyOrderAccountPayload accountPayload,
                                     KeyPair keyPair,
