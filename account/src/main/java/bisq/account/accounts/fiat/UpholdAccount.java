...
public final class UpholdAccount extends Account<FiatPaymentMethod, UpholdAccountPayload> {
    public UpholdAccount(String id,
                         long creationDate,
                         String accountName,
                         UpholdAccountPayload accountPayload,
                         KeyPair keyPair,
