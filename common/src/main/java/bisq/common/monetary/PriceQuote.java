...
public final class PriceQuote implements Comparable<PriceQuote>, PersistableProto {
    ...
    @Override
    public bisq.common.protobuf.PriceQuote toProto(boolean ignoreAnnotation) {
        return buildProto(ignoreAnnotation);
    }

    @Override
    public bisq.common.protobuf.PriceQuote.Builder getBuilder(boolean ignoreAnnotation) {
        return bisq.common.protobuf.PriceQuote.newBuilder().setValue(value)
                .setBaseSideMonetary(baseSideMonetary.toProto(ignoreAnnotation))
                .setQuoteSideMonetary(quoteSideMonetary.toProto(ignoreAnnotation));
    }
