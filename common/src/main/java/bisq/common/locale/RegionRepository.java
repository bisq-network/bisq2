...
public class RegionRepository {
    ...
    public static String getRegionCode(String countryCode) {
        return regionByCountryCodeMap.getOrDefault(countryCode, "Undefined");
    }
