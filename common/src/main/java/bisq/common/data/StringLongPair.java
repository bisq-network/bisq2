...
public final class StringLongPair implements PersistableProto {
    ...
    @Override
    public bisq.common.protobuf.StringLongPair toProto(boolean ignoreAnnotation) {
        return buildProto(ignoreAnnotation);
    }

    @Override
    public bisq.common.protobuf.StringLongPair.Builder getBuilder(boolean ignoreAnnotation) {
