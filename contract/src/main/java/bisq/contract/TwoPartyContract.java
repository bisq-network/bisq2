...
public abstract class TwoPartyContract<T extends Offer<?, ?>> extends Contract<T> {
    ...
    protected bisq.contract.protobuf.TwoPartyContract.Builder getTwoPartyContractBuilder(boolean ignoreAnnotation) {
        return bisq.contract.protobuf.TwoPartyContract.newBuilder().setTaker(taker.toProto(ignoreAnnotation));
    }
