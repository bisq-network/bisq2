...
public abstract class Contract<T extends Offer<?, ?>> implements NetworkProto {
    ...
    @Override
    public abstract bisq.contract.protobuf.Contract toProto(boolean ignoreAnnotation);

    protected bisq.contract.protobuf.Contract.Builder getContractBuilder(boolean ignoreAnnotation) {
