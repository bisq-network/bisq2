...
class ApiChatController extends ApiController {
    ...
    public UserProfile getSelectedUserProfile() {
        return userProfileService.getSelectedUserProfile().get();
    }
    ...
    public UserProfile createUserProfile(@PathVariable("domainId") String domainId,
        ...
        return userProfileService.createNewInitializedUserProfile(profileId,
                nickName,
                "default",
                identity.keyPair(),
                new HashSet<>()).join();
