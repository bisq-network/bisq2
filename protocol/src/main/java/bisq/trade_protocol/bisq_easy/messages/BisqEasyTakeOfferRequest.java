...
package bisq.trade_protocol.bisq_easy.messages;
...
public class BisqEasyTakeOfferRequest extends TradeProtocolMessage {
    ...
    @Override
    protected bisq.protocol.protobuf.TradeProtocolMessage toTradeProtocolMessageProto() {
        return getTradeProtocolMessageBuilder().setBisqEasyTakeOfferRequest(
    ...
    public static BisqEasyTakeOfferRequest fromProto(bisq.protocol.protobuf.TradeProtocolMessage proto) {
