...
import bisq.trade_protocol.tasks.TradeProtocolMessageHandler;
...
@Slf4j
public class BisqEasyTakeOfferRequestHandler extends TradeProtocolMessageHandler<BisqEasyTradeModel, BisqEasyTakeOfferRequest> {
