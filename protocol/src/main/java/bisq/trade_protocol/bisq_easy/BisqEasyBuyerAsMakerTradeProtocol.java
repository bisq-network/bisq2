...
public class BisqEasyBuyerAsMakerTradeProtocol<M extends TradeModel<?, ?>> extends TradeProtocol<M> implements BuyerTradeProtocol, MakerTradeProtocol {

    public BisqEasyBuyerAsMakerTradeProtocol(ServiceProvider serviceProvider, M model) {
