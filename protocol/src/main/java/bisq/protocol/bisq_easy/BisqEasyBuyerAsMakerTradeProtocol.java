...
public class BisqEasyBuyerAsMakerTradeProtocol extends BisqEasyTradeProtocol implements BuyerTradeProtocol, MakerTradeProtocol {

    public BisqEasyBuyerAsMakerTradeProtocol(ServiceProvider serviceProvider, BisqEasyTrade model) {
