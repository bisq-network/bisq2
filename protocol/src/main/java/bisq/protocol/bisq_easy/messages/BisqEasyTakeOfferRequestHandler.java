...
import bisq.protocol.tasks.TradeProtocolMessageHandler;
...
@Slf4j
public class BisqEasyTakeOfferRequestHandler extends TradeProtocolMessageHandler<BisqEasyTrade, BisqEasyTakeOfferRequest> {
