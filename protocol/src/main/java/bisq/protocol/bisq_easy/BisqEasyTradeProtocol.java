...
public abstract class BisqEasyTradeProtocol extends TradeProtocol<BisqEasyTrade> {

    public BisqEasyTradeProtocol(ServiceProvider serviceProvider, BisqEasyTrade model) {
