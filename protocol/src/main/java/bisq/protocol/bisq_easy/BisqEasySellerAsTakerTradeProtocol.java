...
public class BisqEasySellerAsTakerTradeProtocol extends BisqEasyTradeProtocol implements SellerTradeProtocol, TakerTradeProtocol {

    public BisqEasySellerAsTakerTradeProtocol(ServiceProvider serviceProvider, BisqEasyTrade model) {
