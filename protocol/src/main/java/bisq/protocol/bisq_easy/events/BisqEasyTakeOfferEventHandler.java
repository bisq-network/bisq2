...
package bisq.protocol.bisq_easy.events;
...
import bisq.protocol.tasks.SendTradeProtocolMessageHandler;

import java.security.GeneralSecurityException;

public class BisqEasyTakeOfferEventHandler extends SendTradeProtocolMessageHandler<BisqEasyTrade> {
