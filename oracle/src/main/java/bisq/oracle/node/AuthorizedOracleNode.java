...
public final class AuthorizedOracleNode implements AuthorizedDistributedData {
    ...
    @Override
    public bisq.oracle.protobuf.AuthorizedOracleNode toProto() {
        return bisq.oracle.protobuf.AuthorizedOracleNode.newBuilder()
                .setNetworkId(networkId.toProto())
                .build();
    }

    public static AuthorizedOracleNode fromProto(bisq.oracle.protobuf.AuthorizedOracleNode proto) {
    ...
    public static ProtoResolver<DistributedData> getResolver() {
        return any -> {
            try {
                return fromProto(any.unpack(bisq.oracle.protobuf.AuthorizedOracleNode.class));
