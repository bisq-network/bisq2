...
package bisq.i2p_router.common.utils;
...
public class KeyHandlerUtil {
    ...
    public static void handleShutDownKeyEvent(KeyEvent keyEvent, Runnable handler) {
        if (KeyCodeUtils.isCtrlPressed(KeyCode.Q, keyEvent)) {
            handler.run();
        }
    }
    public static void handleCloseKeyEvent(KeyEvent keyEvent, Runnable handler) {
