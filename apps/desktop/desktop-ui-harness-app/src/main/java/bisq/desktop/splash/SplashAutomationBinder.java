...
public final class SplashAutomationBinder extends AbstractDesktopAutomationViewBinder<SplashView> {
    @Override
    public Class<SplashView> viewType() {
