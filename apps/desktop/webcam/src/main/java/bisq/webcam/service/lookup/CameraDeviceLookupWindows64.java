...
/**
 * Adjusted version to make webcam usage work on Windows 64.
 * Tested with Windows ... on a Dell XPS laptop
 */
@Slf4j
public class CameraDeviceLookupWindows64 implements CameraDeviceLookup {
    @Getter
    private final Observable<Integer> deviceNumber = new Observable<>(0);
    @Getter
    private final Observable<Integer> numDevices = new Observable<>();

    public CameraDeviceLookupWindows64() {
    }
