...
@Slf4j
public class NationalBankFormController extends FormController<NationalBankFormView, NationalBankFormModel, NationalBankAccountPayload> {
    public NationalBankFormController(ServiceProvider serviceProvider) {
        super(serviceProvider);
    }

    @Override
    protected NationalBankFormView createView() {
        return new NationalBankFormView(model, this);
    }

    @Override
    protected NationalBankFormModel createModel() {
