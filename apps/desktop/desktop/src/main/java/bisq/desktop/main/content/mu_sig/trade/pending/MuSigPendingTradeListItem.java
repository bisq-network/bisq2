...
package bisq.desktop.main.content.mu_sig.trade.pending;
...
class MuSigPendingTradeListItem implements DateTableItem {
    ...
    public MuSigPendingTradeListItem(MuSigOpenTradeChannel channel,
                                     MuSigTrade trade,
