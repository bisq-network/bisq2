...
public class RevolutAccountDetailsGridPane extends FiatAccountDetailsGridPane<RevolutAccountPayload> {
    ...
    protected void addDetails(RevolutAccountPayload accountPayload) {
        ...
        if (allRevolutCurrencyCodes.equals(selectedCurrencyCodes)) {
            selectedCurrencies = Res.get("user.paymentAccounts.createAccount.accountData.revolut.allRevolutCurrencies");
        } else {
        ...
        Label selectedCurrenciesLabel = addDescriptionAndValue(Res.get("user.paymentAccounts.revolut.selectedCurrencies"),
                selectedCurrencies);
