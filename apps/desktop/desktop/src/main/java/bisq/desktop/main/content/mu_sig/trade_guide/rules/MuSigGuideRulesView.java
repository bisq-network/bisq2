...
@Slf4j
public class MuSigGuideRulesView extends View<VBox, MuSigGuideRulesModel, MuSigGuideRulesController> {
    ...
    public MuSigGuideRulesView(MuSigGuideRulesModel model, MuSigGuideRulesController controller) {
