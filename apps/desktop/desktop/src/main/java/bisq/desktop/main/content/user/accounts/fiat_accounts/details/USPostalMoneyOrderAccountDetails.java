...
public class USPostalMoneyOrderAccountDetails extends FiatAccountDetails<USPostalMoneyOrderAccount> {
    public USPostalMoneyOrderAccountDetails(USPostalMoneyOrderAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        USPostalMoneyOrderAccountPayload accountPayload = account.getAccountPayload();
