...
@Slf4j
public class MuSigGuideProcessView extends View<VBox, MuSigGuideProcessModel, MuSigGuideProcessController> {
    private final Button backButton, nextButton;
    private final Hyperlink learnMore;

    public MuSigGuideProcessView(MuSigGuideProcessModel model, MuSigGuideProcessController controller) {
