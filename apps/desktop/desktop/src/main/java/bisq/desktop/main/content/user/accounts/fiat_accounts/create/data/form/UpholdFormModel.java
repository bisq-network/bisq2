...
@Getter
public class UpholdFormModel extends FormModel {
    ...
    private final RequiredFieldValidator accountIdValidator = new RequiredFieldValidator();

    public UpholdFormModel(String id, List<FiatCurrency> currencies) {
        super(id);
