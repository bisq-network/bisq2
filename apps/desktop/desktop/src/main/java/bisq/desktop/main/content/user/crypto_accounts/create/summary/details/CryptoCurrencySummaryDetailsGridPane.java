...
public class CryptoCurrencySummaryDetailsGridPane<P extends CryptoCurrencyAccountPayload> extends GridPane {
    ...
    public CryptoCurrencySummaryDetailsGridPane(P accountPayload) {
        super(10, 10);
    ...
    protected void addDetails(P accountPayload) {
        String isInstant = accountPayload.isInstant() ? Res.get("confirmation.yes") : Res.get("confirmation.no");
        addDescriptionAndValue(Res.get("paymentAccounts.crypto.summary.details.isInstant"), isInstant);

        if (accountPayload.getIsAutoConf().isPresent() && accountPayload.getIsAutoConf().get()) {
            ...
            Label label = addDescriptionAndValue(Res.get("paymentAccounts.crypto.summary.details.autoConf.description"), autoConfValue);
