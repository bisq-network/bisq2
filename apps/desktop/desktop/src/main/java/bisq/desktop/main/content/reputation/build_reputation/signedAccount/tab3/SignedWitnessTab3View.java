...
public class SignedWitnessTab3View extends View<VBox, SignedWitnessTab3Model, SignedWitnessTab3Controller> {
    ...
    private VBox createAndGetStepTwo() {
        Label title = createAndGetStepLabel(Res.get("reputation.signedWitness.import.step2.title"));
        Label instruction = createAndGetStepInstructionLabel(Res.get("reputation.signedWitness.import.step2.instruction"));
        pubKeyHash = new MaterialTextField(Res.get("reputation.signedWitness.import.step2.profileId"), "");
    ...
    private VBox createAndGetStepThree() {
        Label title = createAndGetStepLabel(Res.get("reputation.signedWitness.import.step3.title"));
        Label instructionOne = createAndGetStepInstructionLabel(Res.get("reputation.signedWitness.import.step3.instruction1"));
        Label instructionTwo = createAndGetStepInstructionLabel(Res.get("reputation.signedWitness.import.step3.instruction2"));
        Label instructionThree = createAndGetStepInstructionLabel(Res.get("reputation.signedWitness.import.step3.instruction3"));
    ...
    private VBox createAndGetStepFour() {
        Label title = createAndGetStepLabel(Res.get("reputation.signedWitness.import.step4.title"));
        Label instruction = createAndGetStepInstructionLabel(Res.get("reputation.signedWitness.import.step4.instruction"));
        jsonData = new MaterialTextArea(Res.get("reputation.signedWitness.import.step4.signedMessage"));
