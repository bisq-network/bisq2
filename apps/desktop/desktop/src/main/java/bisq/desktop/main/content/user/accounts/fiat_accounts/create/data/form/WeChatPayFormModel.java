...
@Getter
public class WeChatPayFormModel extends FormModel {
    ...
    private final TextMinMaxLengthValidator accountNrValidator = new TextMinMaxLengthValidator(
            WeChatPayAccountPayload.ACCOUNT_NR_MIN_LENGTH,
            WeChatPayAccountPayload.ACCOUNT_NR_MAX_LENGTH);

    public WeChatPayFormModel(String id) {
        super(id);
    }
}
