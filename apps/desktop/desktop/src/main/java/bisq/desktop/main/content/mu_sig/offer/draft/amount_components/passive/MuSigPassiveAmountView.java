...
package bisq.desktop.main.content.mu_sig.offer.draft.amount_components.passive;
...
public class MuSigPassiveAmountView extends bisq.desktop.common.view.View<HBox, MuSigPassiveAmountModel, MuSigPassiveAmountController> {
    ...
    private final Label amount, code;
    ...
    protected void onViewAttached() {
        ...
        subscriptions.add(EasyBind.subscribe(model.getUseBitcoinDisplay(), useBitcoinDisplay -> {
