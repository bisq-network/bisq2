...
@Slf4j
public class TradeLimitsView extends TabView<TradeLimitsModel, TradeLimitsController> {
    private Button closeButton;

    public TradeLimitsView(TradeLimitsModel model, TradeLimitsController controller) {
