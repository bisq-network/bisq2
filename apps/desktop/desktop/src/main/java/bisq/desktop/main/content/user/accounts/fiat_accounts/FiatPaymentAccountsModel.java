...
public class FiatPaymentAccountsModel implements Model {
    ...
    private final BooleanProperty saveUserDefinedFiatAccountButtonDisabled = new SimpleBooleanProperty();
    private final BooleanProperty saveUserDefinedFiatAccountButtonVisible = new SimpleBooleanProperty();
    ...
    public void reset() {
        ...
        saveUserDefinedFiatAccountButtonDisabled.set(false);
        saveUserDefinedFiatAccountButtonVisible.set(false);
