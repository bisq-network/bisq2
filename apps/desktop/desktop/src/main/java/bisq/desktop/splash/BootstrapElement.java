        ...
        public void onActivate() {
            networkService.getServiceNodesByTransport().findServiceNode(transportType)
                    .ifPresent(serviceNode -> {
                        ...
                        if (transportService instanceof I2PTransportService i2PTransportService && i2PTransportService.getRouterMode() != null) {
                            ...
                            initializedKey = "splash.stateInfo.initializing." + bootstrapElementTypeName + ".I2P." + routerMode;
                        } else {
