...
public class BizumAccountDetails extends FiatAccountDetails<BizumAccount> {
    public BizumAccountDetails(BizumAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        BizumAccountPayload accountPayload = account.getAccountPayload();
