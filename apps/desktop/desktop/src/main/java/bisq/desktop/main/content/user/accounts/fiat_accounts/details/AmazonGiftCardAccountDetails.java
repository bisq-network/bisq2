...
public class AmazonGiftCardAccountDetails extends FiatAccountDetails<AmazonGiftCardAccount> {
    public AmazonGiftCardAccountDetails(AmazonGiftCardAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        AmazonGiftCardAccountPayload accountPayload = account.getAccountPayload();
