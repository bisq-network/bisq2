...
public class ImpsAccountDetailsGridPane extends FiatAccountDetailsGridPane<ImpsAccountPayload> {
    public ImpsAccountDetailsGridPane(ImpsAccountPayload accountPayload, FiatPaymentRail fiatPaymentRail) {
        super(accountPayload, fiatPaymentRail);
    }

    @Override
    protected void addDetails(ImpsAccountPayload accountPayload) {
        ...
        addDescriptionAndValue(Res.get("paymentAccounts.bank.bankId"),
