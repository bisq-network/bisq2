...
@Slf4j
public class SatispayFormView extends FormView<SatispayFormModel, SatispayFormController> {
    private final MaterialTextField holderName;
    private final MaterialTextField mobileNr;
    private Subscription runValidationPin;

    public SatispayFormView(SatispayFormModel model, SatispayFormController controller) {
