...
public class SatispayAccountDetails extends FiatAccountDetails<SatispayAccount> {
    public SatispayAccountDetails(SatispayAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        SatispayAccountPayload accountPayload = account.getAccountPayload();
