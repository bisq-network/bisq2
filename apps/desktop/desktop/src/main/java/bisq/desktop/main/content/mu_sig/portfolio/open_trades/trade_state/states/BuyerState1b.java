...
public class BuyerState1b extends BaseState {
    ...
    public BuyerState1b(ServiceProvider serviceProvider, MuSigTrade trade, MuSigOpenTradeChannel channel) {
    ...
    private static class Model extends BaseState.Model {
        public Model(MuSigTrade trade, MuSigOpenTradeChannel channel) {
            super(trade, channel);
        }
    }
