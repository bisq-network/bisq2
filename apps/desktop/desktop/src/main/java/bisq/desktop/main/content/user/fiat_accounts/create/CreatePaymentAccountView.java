...
public class CreatePaymentAccountView extends NavigationView<VBox, CreatePaymentAccountModel, CreatePaymentAccountController> {
    ...
    public CreatePaymentAccountView(CreatePaymentAccountModel model, CreatePaymentAccountController controller) {
        ...
        Label paymentMethod = createAndGetProgressLabel(Res.get("paymentAccounts.progress.paymentMethod"));
        progressLabelList.add(paymentMethod);

        Label accountData = createAndGetProgressLabel(Res.get("paymentAccounts.progress.accountData"));
        progressLabelList.add(accountData);

        options = createAndGetProgressLabel(Res.get("paymentAccounts.progress.options"));
        ...
        createAccountButton = new Button(Res.get("paymentAccounts.createAccount.createAccount"));
