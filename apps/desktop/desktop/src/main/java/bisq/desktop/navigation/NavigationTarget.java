...
public enum NavigationTarget {
    ...
    // MU_SIG
    MU_SIG(CONTENT),
    MU_SIG_MARKET(MU_SIG),
    MU_SIG_MARKET_CHART(MU_SIG_MARKET),
    MU_SIG_MARKET_BY_CURRENCY(MU_SIG_MARKET),
    MU_SIG_MARKET_BY_PAYMENT_METHODS(MU_SIG_MARKET),
    MU_SIG_OFFERBOOK_BUY(MU_SIG),
    MU_SIG_OFFERBOOK_BUY_BTC(MU_SIG_OFFERBOOK_BUY),
    MU_SIG_OFFERBOOK_BUY_XMR(MU_SIG_OFFERBOOK_BUY),
    MU_SIG_OFFERBOOK_BUY_OTHER(MU_SIG_OFFERBOOK_BUY),
    MU_SIG_OFFERBOOK_SELL(MU_SIG),
    MU_SIG_OFFERBOOK_SELL_BTC(MU_SIG_OFFERBOOK_SELL),
    MU_SIG_OFFERBOOK_SELL_XMR(MU_SIG_OFFERBOOK_SELL),
    MU_SIG_OFFERBOOK_SELL_OTHER(MU_SIG_OFFERBOOK_SELL),
