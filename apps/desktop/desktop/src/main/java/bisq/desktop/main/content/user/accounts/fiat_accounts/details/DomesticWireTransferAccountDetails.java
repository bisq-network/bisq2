...
public class DomesticWireTransferAccountDetails extends BankAccountDetails<DomesticWireTransferAccountPayload, DomesticWireTransferAccount> {
    public DomesticWireTransferAccountDetails(DomesticWireTransferAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addBankAccountDetails() {
        DomesticWireTransferAccountPayload accountPayload = account.getAccountPayload();
    ...
    private void addHolderAddress(DomesticWireTransferAccountPayload accountPayload) {
