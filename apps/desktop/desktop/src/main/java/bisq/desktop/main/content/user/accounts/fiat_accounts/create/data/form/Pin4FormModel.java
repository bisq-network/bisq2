...
@Getter
public class Pin4FormModel extends FormModel {
    ...
    private final PhoneNumberValidator mobileNrValidator = new PhoneNumberValidator("PL");

    public Pin4FormModel(String id) {
        super(id);
    }
}
