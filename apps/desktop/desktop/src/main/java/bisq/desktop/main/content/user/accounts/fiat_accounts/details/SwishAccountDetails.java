...
public class SwishAccountDetails extends FiatAccountDetails<SwishAccount> {
    public SwishAccountDetails(SwishAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        SwishAccountPayload accountPayload = account.getAccountPayload();
