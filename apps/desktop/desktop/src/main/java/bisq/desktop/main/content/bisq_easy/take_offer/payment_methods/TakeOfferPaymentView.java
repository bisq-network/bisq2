...
@Slf4j
public class TakeOfferPaymentView extends View<StackPane, TakeOfferPaymentModel, TakeOfferPaymentController> {
    ...
    private final Label headlineLabel, fiatSubtitleLabel, bitcoinSubtitleLabel, invalidInputOverlayTextLabel;
    private final VBox fiatVBox, btcVBox, content;
    private final WizardOverlay invalidInputOverlay;
    private final Button invalidInputOverlayCloseButton;
    private Subscription isInvalidInputOverlayVisiblePin;
    ...
    public TakeOfferPaymentView(TakeOfferPaymentModel model, TakeOfferPaymentController controller) {
        ...
        invalidInputOverlayTextLabel = new Label();
        ...
        invalidInputOverlay = new WizardOverlay(root)
                .warning()
                .headlineFromI18nKey("bisqEasy.takeOffer.paymentMethods.invalidInputWizardOverlay.title")
        ...
        root.getChildren().addAll(content, invalidInputOverlay);
    ...
    protected void onViewAttached() {
        ...
        invalidInputOverlayTextLabel.textProperty().bind(model.getInvalidInputOverlayText());

        isInvalidInputOverlayVisiblePin = EasyBind.subscribe(model.getShouldShowInvalidInputOverlay(), shouldShow ->
                invalidInputOverlay.updateOverlayVisibility(content, shouldShow, controller::onKeyPressedWhileShowingInvalidInputOverlay));

        invalidInputOverlayCloseButton.setOnAction(e -> controller.onCloseInvalidInputOverlay());
    }
    ...
    protected void onViewDetached() {
        ...
        invalidInputOverlayTextLabel.textProperty().unbind();

        isInvalidInputOverlayVisiblePin.unsubscribe();

        invalidInputOverlayCloseButton.setOnAction(null);
    }
}
