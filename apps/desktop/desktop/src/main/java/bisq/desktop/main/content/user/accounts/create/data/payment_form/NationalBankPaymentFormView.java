...
@Slf4j
public class NationalBankPaymentFormView extends PaymentFormView<NationalBankPaymentFormModel, NationalBankPaymentFormController> {
    ...
    public NationalBankPaymentFormView(NationalBankPaymentFormModel model,
        ...
        bankName = new MaterialTextField(Res.get("user.paymentAccounts.bank.bankName"),
                Res.get("user.paymentAccounts.createAccount.prompt", StringUtils.unCapitalize(Res.get("user.paymentAccounts.bank.bankName"))));
        ...
        bankAccountTypeComboBox = new AutoCompleteComboBox<>(
                ...
                Res.get("user.paymentAccounts.bank.bankAccountType"),
                Res.get("user.paymentAccounts.createAccount.accountData.bank.bankAccountType.prompt")
        );
        ...
        bankAccountTypeErrorLabel = new Label(Res.get("user.paymentAccounts.createAccount.accountData.bank.bankAccountType.error.noneSelected"));
