...
public class ReputationRankingView extends View<VBox, ReputationRankingModel, ReputationRankingController> {
    public ReputationRankingView(ReputationRankingModel model, ReputationRankingController controller) {
        super(new VBox(50), model, controller);
        root.getChildren().addAll(new Label(getClass().getSimpleName()));
    }
