...
public class SepaInstantAccountDetails extends FiatAccountDetails<SepaInstantAccount> {
    public SepaInstantAccountDetails(SepaInstantAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        SepaInstantAccountPayload accountPayload = account.getAccountPayload();
