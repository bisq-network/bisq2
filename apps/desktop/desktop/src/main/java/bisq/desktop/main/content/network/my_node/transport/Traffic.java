...
public class Traffic {
    ...
    public static class View extends bisq.desktop.common.view.View<HBox, Model, Controller> {
        ...
        private View(Model model, Controller controller) {
            ...
            Label sentHeadline = new Label(Res.get("network.transport.traffic.sent.headline"));
            sentDetails = new Label();
            VBox sentBox = getVBox(sentHeadline, sentDetails);
            sentBox.setFillWidth(true);

            Label receivedHeadline = new Label(Res.get("network.transport.traffic.received.headline"));
        ...
        protected void onViewAttached() {
            sentDetails.setText(Res.get("network.transport.traffic.sent.details",
                    model.getDataSent(),
                    model.getTimeSpentSending(),
                    model.getNumMessagesSent(),
                    model.getSentMessagesDetails(),
                    model.getSentDistributedDataDetails()));
            receivedDetails.setText(Res.get("network.transport.traffic.received.details",
