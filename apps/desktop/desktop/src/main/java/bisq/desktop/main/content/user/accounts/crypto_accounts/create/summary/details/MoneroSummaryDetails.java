...
public class MoneroSummaryDetails extends SummaryDetails<MoneroAccountPayload> {
    public MoneroSummaryDetails(MoneroAccountPayload accountPayload) {
    ...
    protected void addDetails(MoneroAccountPayload accountPayload) {
        ...
        String isUseSubAddresses = BooleanFormatter.toEnabledDisabled(accountPayload.isUseSubAddresses());
        addDescriptionAndValue(Res.get("paymentAccounts.crypto.address.xmr.useSubAddresses"), isUseSubAddresses);
