...
@Slf4j
public class ImpsFormView extends FormView<ImpsFormModel, ImpsFormController> {
    ...
    public ImpsFormView(ImpsFormModel model, ImpsFormController controller) {
        ...
        configOverlay(Res.get("paymentAccounts.createAccount.accountData.backgroundOverlay.imps"));
    }
