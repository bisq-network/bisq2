...
public class SbpAccountDetails extends FiatAccountDetails<SbpAccount> {
    public SbpAccountDetails(SbpAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        SbpAccountPayload accountPayload = account.getAccountPayload();
        ...
        addDescriptionAndValueWithCopyButton(Res.get("paymentAccounts.bank.bankName"),
