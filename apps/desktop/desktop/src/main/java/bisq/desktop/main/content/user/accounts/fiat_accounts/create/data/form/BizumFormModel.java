...
@Getter
public class BizumFormModel extends FormModel {
    ...
    private final PhoneNumberValidator mobileNrValidator = new PhoneNumberValidator("ES");

    public BizumFormModel(String id) {
        super(id);
    }
}
