...
public class ImpsAccountDetails extends FiatAccountDetails<ImpsAccount> {
    public ImpsAccountDetails(ImpsAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        ImpsAccountPayload accountPayload = account.getAccountPayload();
