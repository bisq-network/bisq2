...
@Slf4j
public class HalCashFormView extends FormView<HalCashFormModel, HalCashFormController> {
    private final MaterialTextField mobileNr;
    private Subscription runValidationPin;

    public HalCashFormView(HalCashFormModel model, HalCashFormController controller) {
        ...
        content.getChildren().add(mobileNr);

        configOverlay(Res.get("paymentAccounts.createAccount.accountData.backgroundOverlay.halCash"));
    }
