...
import bisq.desktop.components.controls.validator.fiat.AdvancedCashAccountNrValidator;
...
@Getter
public class AdvancedCashFormModel extends FormModel {
    ...
    private final AdvancedCashAccountNrValidator accountNrValidator = new AdvancedCashAccountNrValidator();

    public AdvancedCashFormModel(String id, List<FiatCurrency> currencies) {
        super(id);
