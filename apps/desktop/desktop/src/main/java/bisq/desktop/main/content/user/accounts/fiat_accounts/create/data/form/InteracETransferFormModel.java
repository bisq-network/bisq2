...
@Getter
public class InteracETransferFormModel extends FormModel {
    ...
    private final RequiredFieldValidator questionValidator = new RequiredFieldValidator();
    private final RequiredFieldValidator answerValidator = new RequiredFieldValidator();

    public InteracETransferFormModel(String id) {
        super(id);
    }
}
