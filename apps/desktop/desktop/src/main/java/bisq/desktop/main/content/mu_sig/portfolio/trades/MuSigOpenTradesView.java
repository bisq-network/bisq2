...
@Slf4j
public class MuSigOpenTradesView extends View<VBox, MuSigOpenTradesModel, MuSigOpenTradesController> {

    public MuSigOpenTradesView(MuSigOpenTradesModel model, MuSigOpenTradesController controller) {
