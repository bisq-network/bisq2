...
@Getter
public class VerseFormModel extends FormModel {
    ...
    private final TextMinMaxLengthValidator holderNameValidator = new TextMinMaxLengthValidator(
            VerseAccountPayload.HOLDER_NAME_MIN_LENGTH,
            VerseAccountPayload.HOLDER_NAME_MAX_LENGTH);

    public VerseFormModel(String id, List<FiatCurrency> currencies) {
        super(id);
