...
public class MoneyBeamAccountDetails extends FiatAccountDetails<MoneyBeamAccount> {
    public MoneyBeamAccountDetails(MoneyBeamAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        MoneyBeamAccountPayload accountPayload = account.getAccountPayload();
