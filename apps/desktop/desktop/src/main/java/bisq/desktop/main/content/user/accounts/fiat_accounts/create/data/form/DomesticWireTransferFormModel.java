...
@Getter
public class DomesticWireTransferFormModel extends FormModel {
    ...
    private final TextMinMaxLengthValidator holderAddressValidator = new TextMinMaxLengthValidator(
            DomesticWireTransferAccountPayload.HOLDER_ADDRESS_MIN_LENGTH,
            DomesticWireTransferAccountPayload.HOLDER_ADDRESS_MAX_LENGTH);
    ...
    private final TextMinMaxLengthValidator bankNameValidator = new TextMinMaxLengthValidator(
            BankAccountPayload.BANK_NAME_MIN_LENGTH,
            BankAccountPayload.BANK_NAME_MAX_LENGTH);

    private final StringProperty bankId = new SimpleStringProperty();
    private final TextMinMaxLengthValidator bankIdValidator = new TextMinMaxLengthValidator(
            BankAccountPayload.BANK_ID_MIN_LENGTH,
    ...
    private final TextMinMaxLengthValidator accountNrValidator = new TextMinMaxLengthValidator(
            BankAccountPayload.ACCOUNT_NR_MIN_LENGTH,
            BankAccountPayload.ACCOUNT_NR_MAX_LENGTH);

    public DomesticWireTransferFormModel(String id) {
        super(id);
    }
}
