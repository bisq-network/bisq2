...
public class VerseAccountDetails extends FiatAccountDetails<VerseAccount> {
    public VerseAccountDetails(VerseAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        VerseAccountPayload accountPayload = account.getAccountPayload();
