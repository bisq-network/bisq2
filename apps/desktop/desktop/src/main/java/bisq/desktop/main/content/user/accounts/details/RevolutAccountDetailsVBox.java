...
public class RevolutAccountDetailsVBox extends FiatAccountDetailsVBox<RevolutAccount> {
    public RevolutAccountDetailsVBox(RevolutAccount account) {
        super(account);
    }
    ...
    protected void addDetails(RevolutAccount account) {
        ...
        String allRevolutCurrencies = Res.get("user.paymentAccounts.createAccount.accountData.revolut.allRevolutCurrencies");
        ...
        Label selectedCurrenciesLabel = addDescriptionAndValueWithCopyButton(Res.get("user.paymentAccounts.revolut.selectedCurrencies"),
