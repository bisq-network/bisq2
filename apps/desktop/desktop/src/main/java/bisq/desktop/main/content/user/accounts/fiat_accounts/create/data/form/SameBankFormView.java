...
@Slf4j
public class SameBankFormView extends FormView<SameBankFormModel, SameBankFormController> {
    ...
    public SameBankFormView(SameBankFormModel model,
                            SameBankFormController controller) {
