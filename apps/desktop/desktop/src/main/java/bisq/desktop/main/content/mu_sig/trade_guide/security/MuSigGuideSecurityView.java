...
@Slf4j
public class MuSigGuideSecurityView extends View<VBox, MuSigGuideSecurityModel, MuSigGuideSecurityController> {
    private final Button backButton, nextButton;
    private final Hyperlink learnMore;

    public MuSigGuideSecurityView(MuSigGuideSecurityModel model, MuSigGuideSecurityController controller) {
