...
public class LightningPreImageValidator extends ValidatorBase {

    public LightningPreImageValidator(String message) {
        super(message);
    }

    public LightningPreImageValidator() {
        super(Res.get("validation.invalidLightningPreimage"));
    }
