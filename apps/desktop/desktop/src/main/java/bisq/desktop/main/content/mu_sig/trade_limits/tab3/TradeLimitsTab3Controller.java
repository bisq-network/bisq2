...
@Slf4j
public class TradeLimitsTab3Controller implements Controller {

    private final TradeLimitsTab3Model model;
    @Getter
    private final TradeLimitsTab3View view;
    private final UserIdentityService userIdentityService;
    private Pin selectedUserProfilePin;

    public TradeLimitsTab3Controller(ServiceProvider serviceProvider) {
        ...
        model = new TradeLimitsTab3Model();
        view = new TradeLimitsTab3View(model, this, userProfileSelection.getRoot());
    }
