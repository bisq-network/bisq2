...
@Slf4j
public class FasterPaymentsFormView extends FormView<FasterPaymentsFormModel, FasterPaymentsFormController> {
    private final MaterialTextField holderName, sortCode, accountNr;
    private Subscription runValidationPin;

    public FasterPaymentsFormView(FasterPaymentsFormModel model,
                                  FasterPaymentsFormController controller) {
