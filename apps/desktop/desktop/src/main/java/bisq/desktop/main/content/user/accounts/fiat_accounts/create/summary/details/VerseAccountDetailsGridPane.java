...
public class VerseAccountDetailsGridPane extends FiatAccountDetailsGridPane<VerseAccountPayload> {
    public VerseAccountDetailsGridPane(VerseAccountPayload accountPayload, FiatPaymentRail fiatPaymentRail) {
        super(accountPayload, fiatPaymentRail);
    }

    @Override
    protected void addDetails(VerseAccountPayload accountPayload) {
