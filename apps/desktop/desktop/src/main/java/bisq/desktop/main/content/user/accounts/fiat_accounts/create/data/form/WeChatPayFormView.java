...
@Slf4j
public class WeChatPayFormView extends FormView<WeChatPayFormModel, WeChatPayFormController> {
    private final MaterialTextField accountNr;
    private Subscription runValidationPin;

    public WeChatPayFormView(WeChatPayFormModel model, WeChatPayFormController controller) {
