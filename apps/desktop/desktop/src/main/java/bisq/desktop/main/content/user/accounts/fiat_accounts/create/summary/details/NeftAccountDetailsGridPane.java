...
public class NeftAccountDetailsGridPane extends FiatAccountDetailsGridPane<NeftAccountPayload> {
    public NeftAccountDetailsGridPane(NeftAccountPayload accountPayload, FiatPaymentRail fiatPaymentRail) {
        super(accountPayload, fiatPaymentRail);
    }

    @Override
    protected void addDetails(NeftAccountPayload accountPayload) {
