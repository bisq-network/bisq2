...
public class PerfectMoneyAccountDetails extends FiatAccountDetails<PerfectMoneyAccount> {
    public PerfectMoneyAccountDetails(PerfectMoneyAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        PerfectMoneyAccountPayload accountPayload = account.getAccountPayload();
