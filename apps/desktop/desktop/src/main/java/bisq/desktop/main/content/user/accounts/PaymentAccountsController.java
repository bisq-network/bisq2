...
import bisq.desktop.main.content.user.accounts.details.fiat.F2FAccountDetailsVBox;
import bisq.desktop.main.content.user.accounts.details.fiat.FasterPaymentsAccountDetailsVBox;
import bisq.desktop.main.content.user.accounts.details.fiat.NationalBankAccountDetailsVBox;
import bisq.desktop.main.content.user.accounts.details.fiat.PixAccountDetailsVBox;
import bisq.desktop.main.content.user.accounts.details.fiat.RevolutAccountDetailsVBox;
import bisq.desktop.main.content.user.accounts.details.fiat.SepaAccountDetailsVBox;
import bisq.desktop.main.content.user.accounts.details.fiat.UserDefinedAccountDetailsVBox;
import bisq.desktop.main.content.user.accounts.details.fiat.ZelleAccountDetailsVBox;
