...
@Slf4j
public class FiatPPaymentAccountsView extends View<VBox, FiatPPaymentAccountsModel, FiatPaymentAccountsController> {
    ...
    public FiatPPaymentAccountsView(FiatPPaymentAccountsModel model, FiatPaymentAccountsController controller) {
