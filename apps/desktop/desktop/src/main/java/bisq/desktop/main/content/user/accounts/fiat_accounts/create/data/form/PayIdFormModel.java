...
@Getter
public class PayIdFormModel extends FormModel {
    ...
    private final StringProperty payId = new SimpleStringProperty();
    ...
    private final RequiredFieldValidator payIdValidator = new RequiredFieldValidator();

    public PayIdFormModel(String id) {
        super(id);
    }
}
