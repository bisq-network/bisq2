    ...
    public static class View extends bisq.desktop.common.view.View<VBox, Model, Controller> {
        ...
        private void configConnectionsTableView() {
            ...
            connectionsTableView.getColumns().add(new BisqTableColumn.Builder<ConnectionListItem>()
                    .title(Res.get("network.connections.header.peer"))
                    .minWidth(130)
                    ...
                    .build());
            connectionsTableView.getColumns().add(new BisqTableColumn.Builder<ConnectionListItem>()
                    .title(Res.get("network.connections.header.address"))
                    .minWidth(130)
                    ...
                    .build());
            connectionsTableView.getColumns().add(new BisqTableColumn.Builder<ConnectionListItem>()
                    .title(Res.get("network.header.nodeTag"))
                    .minWidth(120)
                    ...
                    .build());
            connectionsTableView.getColumns().add(new BisqTableColumn.Builder<ConnectionListItem>()
                    .title(Res.get("network.connections.header.connectionDirection"))
                    .minWidth(100)
                    .valueSupplier(ConnectionListItem::getDirection)
                    .comparator(ConnectionListItem::compareDirection)
                    .build());
            connectionsTableView.getColumns().add(new BisqTableColumn.Builder<ConnectionListItem>()
                    .title(Res.get("network.connections.header.sentHeader"))
                    .minWidth(160)
                    ...
                    .build());
            connectionsTableView.getColumns().add(new BisqTableColumn.Builder<ConnectionListItem>()
                    .title(Res.get("network.connections.header.receivedHeader"))
                    .minWidth(160)
                    ...
                    .build());
            connectionsTableView.getColumns().add(new BisqTableColumn.Builder<ConnectionListItem>()
                    .title(Res.get("network.connections.header.rtt"))
                    .minWidth(100)
        ...
        private void configNodesTableView() {
            nodesTableView.getColumns().add(new BisqTableColumn.Builder<NodeListItem>()
                    .title(Res.get("network.nodes.header.type"))
                    .minWidth(70)
                    .left()
            ...
            nodesTableView.getColumns().add(new BisqTableColumn.Builder<NodeListItem>()
                    ...
                    .build());
            nodesTableView.getColumns().add(new BisqTableColumn.Builder<NodeListItem>()
                    .title(Res.get("network.nodes.header.address"))
                    .minWidth(130)
            ...
            BisqTableColumn<NodeListItem> numConnections = new BisqTableColumn.Builder<NodeListItem>()
                    .title(Res.get("network.nodes.header.numConnections"))
                    .minWidth(170)
            ...
            nodesTableView.getColumns().add(new BisqTableColumn.Builder<NodeListItem>()
                    .title(Res.get("network.nodes.header.keyId"))
                    .minWidth(100)
