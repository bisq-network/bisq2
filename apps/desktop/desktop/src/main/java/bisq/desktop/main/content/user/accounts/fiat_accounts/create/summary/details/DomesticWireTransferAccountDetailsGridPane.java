...
public class DomesticWireTransferAccountDetailsGridPane extends BankAccountDetailsGridPane<DomesticWireTransferAccountPayload> {
    public DomesticWireTransferAccountDetailsGridPane(DomesticWireTransferAccountPayload accountPayload,
                                                      FiatPaymentRail fiatPaymentRail) {
        super(accountPayload, fiatPaymentRail);
    }

    @Override
    protected void addDetails(DomesticWireTransferAccountPayload accountPayload) {
