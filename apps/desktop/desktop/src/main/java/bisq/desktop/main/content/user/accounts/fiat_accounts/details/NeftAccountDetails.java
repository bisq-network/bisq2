...
public class NeftAccountDetails extends FiatAccountDetails<NeftAccount> {
    public NeftAccountDetails(NeftAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        NeftAccountPayload accountPayload = account.getAccountPayload();
