...
public class Pin4AccountDetails extends FiatAccountDetails<Pin4Account> {
    public Pin4AccountDetails(Pin4Account account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        Pin4AccountPayload accountPayload = account.getAccountPayload();
