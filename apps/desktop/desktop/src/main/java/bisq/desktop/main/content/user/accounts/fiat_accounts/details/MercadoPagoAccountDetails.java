...
public class MercadoPagoAccountDetails extends FiatAccountDetails<MercadoPagoAccount> {
    public MercadoPagoAccountDetails(MercadoPagoAccount account, AccountTimestampService accountTimestampService) {
