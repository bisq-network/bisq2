...
public class AllNetworkPeersView extends View<VBox, AllNetworkPeersModel, AllNetworkPeersController> {
    ...
    public AllNetworkPeersView(AllNetworkPeersModel model,
                               AllNetworkPeersController controller) {
        super(new VBox(), model, controller);

        richTableView = new RichTableView<>(model.getSortedList(),
                Res.get("network.peers.table.headline"),
    ...
    public static class ListItem {
        ...
        private final AllNetworkPeersController controller;
