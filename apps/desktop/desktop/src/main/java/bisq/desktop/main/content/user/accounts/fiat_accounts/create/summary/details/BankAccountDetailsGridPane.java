...
public abstract class BankAccountDetailsGridPane<T extends BankAccountPayload> extends FiatAccountDetailsGridPane<T> {
    public BankAccountDetailsGridPane(T accountPayload,
                                      FiatPaymentRail fiatPaymentRail) {
        super(accountPayload, fiatPaymentRail);
    }

    protected void addDetails(T accountPayload) {
        addHolderName(accountPayload);
        addAccountData(accountPayload);
        addBankInfo(accountPayload);
    }

    protected void addHolderName(T accountPayload) {
    ...
    protected void addAccountData(T accountPayload) {
        String countryCode = accountPayload.getCountryCode();
        ...
        Optional<Pair<String, String>> bankAccountTypeDescriptionValue = accountPayload.getBankAccountType()
                .map(value -> new Pair<>(Res.get("paymentAccounts.bank.bankAccountType"), value.toDisplayString()));
    ...
    protected void addBankInfo(T accountPayload) {
        String countryCode = accountPayload.getCountryCode();
