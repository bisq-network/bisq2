...
package bisq.desktop.main.content.mu_sig.offer.draft.take_offer.amount.old;
...
import bisq.desktop.main.content.mu_sig.offer.draft.components.amount_selection.MuSigAmountSelectionController;
...
public class MuSigTakeOfferAmountController implements Controller {
    ...
    public MuSigTakeOfferAmountController(ServiceProvider serviceProvider,
        ...
        amountSelectionController = new MuSigAmountSelectionController(serviceProvider, takeOfferService);
