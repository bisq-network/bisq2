...
public class MoneyGramAccountDetailsGridPane extends FiatAccountDetailsGridPane<MoneyGramAccountPayload> {
    public MoneyGramAccountDetailsGridPane(MoneyGramAccountPayload accountPayload, FiatPaymentRail fiatPaymentRail) {
        super(accountPayload, fiatPaymentRail);
    }

    @Override
    protected void addDetails(MoneyGramAccountPayload accountPayload) {
        ...
        if (allCurrencyCodes.equals(selectedCurrencyCodes)) {
            selectedCurrencies = Res.get("paymentAccounts.createAccount.accountData.moneyGram.allMoneyGramCurrencies");
        } else {
        ...
        Label selectedCurrenciesLabel = addDescriptionAndValue(Res.get("paymentAccounts.moneyGram.selectedCurrencies"),
                selectedCurrencies);
