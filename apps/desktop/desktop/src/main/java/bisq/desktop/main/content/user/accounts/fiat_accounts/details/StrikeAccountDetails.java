...
public class StrikeAccountDetails extends FiatAccountDetails<StrikeAccount> {
    public StrikeAccountDetails(StrikeAccount account, AccountTimestampService accountTimestampService) {
        super(account, accountTimestampService);
    }

    @Override
    protected void addDetails() {
        StrikeAccountPayload accountPayload = account.getAccountPayload();
