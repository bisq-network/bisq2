...
@Getter
public class MoneyGramFormModel extends FormModel {
    ...
    private final RequiredFieldValidator stateValidator = new RequiredFieldValidator();

    public MoneyGramFormModel(String id,
