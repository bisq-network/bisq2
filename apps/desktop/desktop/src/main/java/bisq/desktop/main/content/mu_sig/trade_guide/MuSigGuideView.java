...
@Slf4j
public class MuSigGuideView extends TabView<MuSigGuideModel, MuSigGuideController> {
    private Button closeIconButton;

    public MuSigGuideView(MuSigGuideModel model, MuSigGuideController controller) {
