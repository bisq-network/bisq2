...
import bisq.desktop.main.content.user.accounts.create.data.payment_form.fiat.F2FPaymentFormController;
import bisq.desktop.main.content.user.accounts.create.data.payment_form.fiat.FasterPaymentsPaymentFormController;
import bisq.desktop.main.content.user.accounts.create.data.payment_form.fiat.NationalBankPaymentFormController;
import bisq.desktop.main.content.user.accounts.create.data.payment_form.fiat.PaymentFormController;
import bisq.desktop.main.content.user.accounts.create.data.payment_form.fiat.RevolutPaymentFormController;
import bisq.desktop.main.content.user.accounts.create.data.payment_form.fiat.SepaPaymentFormController;
import bisq.desktop.main.content.user.accounts.create.data.payment_form.fiat.ZellePaymentFormController;
import bisq.desktop.main.content.user.accounts.create.data.payment_form.fiat.PixPaymentFormController;
