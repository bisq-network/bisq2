...
package bisq.desktop.main.content.mu_sig.offer.take_offer;
...
@Slf4j
public class MuSigTakeOfferView extends NavigationView<VBox, MuSigTakeOfferModel, MuSigTakeOfferController> {
    ...
    public MuSigTakeOfferView(MuSigTakeOfferModel model, MuSigTakeOfferController controller) {
        ...
        takeOfferButton = new Button(Res.get("muSig.offer.taker.review.takeOffer"));
