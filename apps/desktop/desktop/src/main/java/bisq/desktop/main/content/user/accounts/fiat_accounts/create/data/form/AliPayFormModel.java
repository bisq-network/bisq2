...
@Getter
public class AliPayFormModel extends FormModel {
    ...
    private final TextMinMaxLengthValidator accountNrValidator = new TextMinMaxLengthValidator(
            AliPayAccountPayload.ACCOUNT_NR_MIN_LENGTH,
            AliPayAccountPayload.ACCOUNT_NR_MAX_LENGTH);

    public AliPayFormModel(String id) {
        super(id);
    }
}
