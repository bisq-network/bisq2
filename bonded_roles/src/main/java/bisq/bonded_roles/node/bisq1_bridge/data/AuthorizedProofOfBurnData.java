...
public final class AuthorizedProofOfBurnData implements AuthorizedDistributedData {
    ...
    @Override
    public bisq.bonded_roles.protobuf.AuthorizedProofOfBurnData toProto() {
        return bisq.bonded_roles.protobuf.AuthorizedProofOfBurnData.newBuilder()
                .setAmount(amount)
                .setTime(time)
    ...
    public static AuthorizedProofOfBurnData fromProto(bisq.bonded_roles.protobuf.AuthorizedProofOfBurnData proto) {
        return new AuthorizedProofOfBurnData(
                proto.getAmount(),
                proto.getTime(),
    ...
    public static ProtoResolver<DistributedData> getResolver() {
        return any -> {
            try {
                return fromProto(any.unpack(bisq.bonded_roles.protobuf.AuthorizedProofOfBurnData.class));
