...
public class Persistence<T extends PersistableStore<T>> {
    ...
    public Persistence(String directory, String fileName, BackupService.Priority backupPriority) {
        ...
        var storeFileManager = new PersistableStoreFileManager(storePath, backupPriority);
