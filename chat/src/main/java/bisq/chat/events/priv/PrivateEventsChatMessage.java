...
public final class PrivateEventsChatMessage extends PrivateChatMessage {
    ...
    public bisq.chat.protobuf.ChatMessage toChatMessageProto() {
        return getChatMessageBuilder()
                .setPrivateEventsChatMessage(bisq.chat.protobuf.PrivateEventsChatMessage.newBuilder()
                        .setReceiversId(receiversId)
                        .setSender(sender.toProto()))
                .build();
    }

    public static PrivateEventsChatMessage fromProto(bisq.chat.protobuf.ChatMessage baseProto) {
