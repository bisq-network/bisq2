...
public class PrivateEventsChannelService extends PrivateChannelService<PrivateEventsChatMessage, PrivateEventsChannel, PrivateEventsChannelStore> {
    ...
    @Override
    protected PrivateEventsChatMessage createNewPrivateChatMessage(String messageId,
                                                                   PrivateEventsChannel channel,
                                                                   UserProfile sender,
                                                                   String receiversId,
                                                                   String text,
                                                                   ...
                                                                   long time,
                                                                   boolean wasEdited) {
        return new PrivateEventsChatMessage(messageId,
                channel.getId(),
                sender,
                receiversId,
                text,
