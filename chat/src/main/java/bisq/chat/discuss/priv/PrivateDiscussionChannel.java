...
public final class PrivateDiscussionChannel extends PrivateChannel<PrivateDiscussionChatMessage> {
    ...
    public PrivateDiscussionChannel(UserProfile peer, UserIdentity myUserIdentity) {
    ...
    private PrivateDiscussionChannel(String id,
        ...
        super(id, myProfile, chatMessages, channelNotificationType, ChannelKind.DISCUSSION);
