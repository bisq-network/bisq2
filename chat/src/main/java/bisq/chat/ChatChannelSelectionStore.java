...
public final class ChatChannelSelectionStore implements PersistableStore<ChatChannelSelectionStore> {
    ...
    @Override
    public bisq.chat.protobuf.ChatChannelSelectionStore.Builder getBuilder(boolean ignoreAnnotation) {
    ...
    @Override
    public bisq.chat.protobuf.ChatChannelSelectionStore toProto(boolean ignoreAnnotation) {
