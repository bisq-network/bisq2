...
public class TwoPartyPrivateChatChannelStore implements PersistableStore<TwoPartyPrivateChatChannelStore> {
    ...
    @Override
    public bisq.chat.protobuf.TwoPartyPrivateChatChannelStore.Builder getBuilder(boolean ignoreAnnotation) {
    ...
    @Override
    public bisq.chat.protobuf.TwoPartyPrivateChatChannelStore toProto(boolean ignoreAnnotation) {
