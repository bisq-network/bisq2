...
public class MuSigOpenTradeMessageReaction extends PrivateChatMessageReaction {
    ...
    public bisq.chat.protobuf.ChatMessageReaction.Builder getValueBuilder(boolean serializeForHash) {
        return getChatMessageReactionBuilder(serializeForHash)
                .setMuSigOpenTradeMessageReaction(toMuSigOpenTradeMessageReactionProto(serializeForHash));
    }

    private bisq.chat.protobuf.MuSigOpenTradeMessageReaction toMuSigOpenTradeMessageReactionProto(boolean serializeForHash) {
        return resolveBuilder(getMuSigOpenTradeMessageReactionBuilder(serializeForHash), serializeForHash).build();
    }

    private bisq.chat.protobuf.MuSigOpenTradeMessageReaction.Builder getMuSigOpenTradeMessageReactionBuilder(boolean serializeForHash) {
        return bisq.chat.protobuf.MuSigOpenTradeMessageReaction.newBuilder()
    ...
    public static MuSigOpenTradeMessageReaction fromProto(bisq.chat.protobuf.ChatMessageReaction baseProto) {
        bisq.chat.protobuf.MuSigOpenTradeMessageReaction privateChatMessageReaction = baseProto.getMuSigOpenTradeMessageReaction();
