...
public class PrivateTradeChannelService extends ChannelService<PrivateTradeChannel>
    ...
    public void selectChannel(Channel<? extends ChatMessage> channel) {
        removeExpiredMessages((PrivateTradeChannel) channel);
        getSelected().set(channel);
        persist();
    }
    ...
    public Observable<Channel<? extends ChatMessage>> getSelected() {
        return persistableStore.getSelected();
    }
    ...
    private void removeExpiredMessages(PrivateTradeChannel channel) {
