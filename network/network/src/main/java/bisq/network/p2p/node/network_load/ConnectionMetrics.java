...
public class ConnectionMetrics {
    ...
    public void onSent(NetworkEnvelope networkEnvelope, long spentTime) {
        ...
        sentBytesPerMinute.get(ageInMinutes).getAndAdd(networkEnvelope.toProto(true).getSerializedSize());
    ...
    public void onReceived(NetworkEnvelope networkEnvelope, long deserializeTime) {
        ...
        receivedBytesPerMinute.get(ageInMinutes).getAndAdd(networkEnvelope.toProto(true).getSerializedSize());
