...
public final class MailboxData implements StorageData {
    ...
    /**
     * Written explicitly rather than generated by the class level {@code @Getter}, because this is the accessor that
     * exempts MailboxData from declaring a policy of its own. A generated one would leave both the exemption and the
     * compile time check that relies on it depending on annotation processor ordering.
     */
    @Override
