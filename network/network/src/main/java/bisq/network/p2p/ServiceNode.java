...
public class ServiceNode {
    ...
    public static final class Config {
        public static Config from(com.typesafe.config.Config config) {
            return new Config(new HashSet<>(config.getEnumList(ServiceType.class, "p2pServiceNode")));
        }

        private final Set<ServiceType> serviceTypes;

        public Config(Set<ServiceType> serviceTypes) {
    ...
    public void createDefaultNode(NetworkId defaultNetworkId, TorIdentity defaultTorIdentity) {
        ...
        Set<ServiceType> serviceTypes = config.getServiceTypes();
        peerGroupService = serviceTypes.contains(ServiceType.PEER_GROUP) ?
        ...
        boolean dataServiceEnabled = serviceTypes.contains(ServiceType.PEER_GROUP) && serviceTypes.contains(ServiceType.DATA);
        ...
        confidentialMessageService = serviceTypes.contains(ServiceType.CONFIDENTIAL) ?
