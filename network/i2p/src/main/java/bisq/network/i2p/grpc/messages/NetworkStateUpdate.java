...
@EqualsAndHashCode
@ToString
public final class NetworkStateUpdate implements Proto {
    @Getter
    ...
    @Override
    public bisq.bi2p.protobuf.NetworkStateUpdate completeProto() {
    ...
    @Override
    public bisq.bi2p.protobuf.NetworkStateUpdate.Builder getBuilder(boolean serializeForHash) {
        return bisq.bi2p.protobuf.NetworkStateUpdate.newBuilder()
                .setValue(value.toProtoEnum());
    }

    public static NetworkStateUpdate fromProto(bisq.bi2p.protobuf.NetworkStateUpdate proto) {
