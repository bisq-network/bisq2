...
public enum NetworkState implements ProtoEnum {
    ...
    @Override
    public bisq.i2p.protobuf.NetworkState toProtoEnum() {
        return bisq.i2p.protobuf.NetworkState.valueOf(getProtobufEnumPrefix() + name());
    }

    public static NetworkState fromProto(bisq.i2p.protobuf.NetworkState proto) {
