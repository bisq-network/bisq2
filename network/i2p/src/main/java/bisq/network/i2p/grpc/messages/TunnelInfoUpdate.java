...
public class TunnelInfoUpdate implements Proto {
    ...
    @Override
    public bisq.bi2p.protobuf.TunnelInfoUpdate completeProto() {
    ...
    @Override
    public bisq.bi2p.protobuf.TunnelInfoUpdate.Builder getBuilder(boolean serializeForHash) {
        return bisq.bi2p.protobuf.TunnelInfoUpdate.newBuilder()
                .setValue(value.toProto(serializeForHash));
    }

    public static TunnelInfoUpdate fromProto(bisq.bi2p.protobuf.TunnelInfoUpdate proto) {
