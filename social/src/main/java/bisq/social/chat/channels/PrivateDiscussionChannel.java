...
public final class PrivateDiscussionChannel extends Channel<PrivateDiscussionChatMessage> implements PrivateChannel {
    ...
    public PrivateDiscussionChannel(PublicUserProfile peer, UserProfile myProfile) {
    ...
    public PrivateDiscussionChannel(String id, PublicUserProfile peer, UserProfile myProfile) {
