...
public interface PriceSpec extends NetworkProto {
    ...
    default bisq.offer.protobuf.PriceSpec.Builder getPriceSpecBuilder(boolean ignoreAnnotation) {
        return bisq.offer.protobuf.PriceSpec.newBuilder();
    }

    @Override
    bisq.offer.protobuf.PriceSpec toProto(boolean ignoreAnnotation);
