...
public interface AmountSpec extends NetworkProto {
    @Override
    bisq.offer.protobuf.AmountSpec toProto(boolean ignoreAnnotation);

    default bisq.offer.protobuf.AmountSpec.Builder getAmountSpecBuilder(boolean ignoreAnnotation) {
