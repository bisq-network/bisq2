...
public class ElementsdGetPeginAddressRpcCall extends WalletRpcCall<Void, ElementsdGetPeginAddressResponse> {
    ...
    public String getRpcMethodName() {
        return "getpeginaddress";
    }

    @Override
    public boolean isResponseValid(ElementsdGetPeginAddressResponse response) {
        return true;
    }

    @Override
    public Class<ElementsdGetPeginAddressResponse> getRpcResponseClass() {
        return ElementsdGetPeginAddressResponse.class;
    }
}
