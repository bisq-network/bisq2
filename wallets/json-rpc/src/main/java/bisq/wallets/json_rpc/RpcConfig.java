...
public final class RpcConfig implements PersistableProto {
    ...
    @Override
    public bisq.wallets.protobuf.RpcConfig toProto(boolean ignoreAnnotation) {
        return buildProto(ignoreAnnotation);
    }

    @Override
    public bisq.wallets.protobuf.RpcConfig.Builder getBuilder(boolean ignoreAnnotation) {
