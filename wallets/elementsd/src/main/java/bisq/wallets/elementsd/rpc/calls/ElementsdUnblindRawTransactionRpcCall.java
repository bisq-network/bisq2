...
public class ElementsdUnblindRawTransactionRpcCall
    ...
    @Override
    public boolean isResponseValid(ElementsdUnblindRawTransactionResponse response) {
        return true;
    }

    @Override
    public Class<ElementsdUnblindRawTransactionResponse> getRpcResponseClass() {
        return ElementsdUnblindRawTransactionResponse.class;
    }
}
