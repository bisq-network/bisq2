...
public class ElementsdStartupIntegrationTests
        extends WalletStartupTests<MultiProcessCoordinator, ElementsdWallet> {
    @Override
    public AbstractRegtestSetup<MultiProcessCoordinator, ElementsdWallet> createRegtestSetup()
            throws IOException {
