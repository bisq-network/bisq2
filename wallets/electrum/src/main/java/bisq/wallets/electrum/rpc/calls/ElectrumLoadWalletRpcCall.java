...
public class ElectrumLoadWalletRpcCall extends DaemonRpcCall<ElectrumLoadWalletRpcCall.Request, ElectrumBooleanResponse> {
    ...
    public ElectrumLoadWalletRpcCall(Request request) {
        super(request);
    }
