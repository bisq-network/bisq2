...
public final class AuthorizedOracleNode implements AuthorizedDistributedData {
    ...
    @Override
    public bisq.bonded_roles.protobuf.AuthorizedOracleNode.Builder getBuilder(boolean ignoreAnnotation) {
    ...
    @Override
    public bisq.bonded_roles.protobuf.AuthorizedOracleNode toProto(boolean ignoreAnnotation) {
