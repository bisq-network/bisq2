...
public final class ReleaseNotification implements AuthorizedDistributedData {
    ...
    @Override
    public bisq.bonded_roles.protobuf.ReleaseNotification.Builder getBuilder(boolean ignoreAnnotation) {
    ...
    @Override
    public bisq.bonded_roles.protobuf.ReleaseNotification toProto(boolean ignoreAnnotation) {
