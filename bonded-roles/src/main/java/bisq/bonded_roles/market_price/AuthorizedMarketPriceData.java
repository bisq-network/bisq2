...
public final class AuthorizedMarketPriceData implements AuthorizedDistributedData {
    ...
    @Override
    public bisq.bonded_roles.protobuf.AuthorizedMarketPriceData.Builder getBuilder(boolean ignoreAnnotation) {
    ...
    @Override
    public bisq.bonded_roles.protobuf.AuthorizedMarketPriceData toProto(boolean ignoreAnnotation) {
