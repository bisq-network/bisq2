...
public final class BondedRoleRegistrationRequest implements MailboxMessage {
    ...
    public bisq.network.protobuf.EnvelopePayloadMessage.Builder getBuilder(boolean ignoreAnnotation) {
        return getNetworkMessageBuilder()
                .setExternalNetworkMessage(ExternalNetworkMessage.newBuilder()
                        .setAny(Any.pack(toBondedRoleRegistrationRequestProto(ignoreAnnotation))));
    }
    ...
    public bisq.bonded_roles.protobuf.BondedRoleRegistrationRequest toBondedRoleRegistrationRequestProto(boolean ignoreAnnotation) {
