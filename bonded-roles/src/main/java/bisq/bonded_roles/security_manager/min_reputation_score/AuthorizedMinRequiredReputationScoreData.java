...
public final class AuthorizedMinRequiredReputationScoreData implements AuthorizedDistributedData {
    ...
    @Override
    public bisq.bonded_roles.protobuf.AuthorizedMinRequiredReputationScoreData.Builder getBuilder(boolean ignoreAnnotation) {
    ...
    @Override
    public bisq.bonded_roles.protobuf.AuthorizedMinRequiredReputationScoreData toProto(boolean ignoreAnnotation) {
