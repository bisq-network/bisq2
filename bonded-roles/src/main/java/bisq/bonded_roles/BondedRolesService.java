...
public class BondedRolesService implements Service {
    ...
    public BondedRolesService(Config config,
        ...
        explorerService = new ExplorerService(BaseService.Config.from(config.getBlockchainExplorer()), networkService);
        ...
        mobileNotificationRelayClient = new MobileNotificationRelayClient(BaseService.Config.from(config.getMobileNotifications()), networkService);
    }
