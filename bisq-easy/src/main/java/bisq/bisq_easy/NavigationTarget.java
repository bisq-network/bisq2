...
public enum NavigationTarget {
    ...
    TRADE_WIZARD_DIRECTION_AND_MARKET(TRADE_WIZARD, false),
    TRADE_WIZARD_AMOUNT_AND_PRICE(TRADE_WIZARD, false),
    ...
    // BISQ_MUSIG
    BISQ_MUSIG(CONTENT),
    BISQ_MUSIG_ONBOARDING(BISQ_MUSIG),
    BISQ_MUSIG_OFFERBOOK(BISQ_MUSIG),
