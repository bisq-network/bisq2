...
public enum CookieKey {
    ...
    SHOW_NETWORK_BOOTSTRAP_DETAILS, // Not used anymore with v2.1.7
    ...
    MU_SIG_FIAT_MARKET_IS_DEFAULT_AMOUNT_INPUT_BTC,
    MU_SIG_OTHER_MARKET_IS_DEFAULT_AMOUNT_INPUT_BTC,
    MU_SIG_CREATE_OFFER_USE_BUY_DIRECTION,
    MU_SIG_CREATE_OFFER_USE_FIX_PRICE(true),
    MU_SIG_CREATE_OFFER_PERCENTAGE_PRICE(true);
