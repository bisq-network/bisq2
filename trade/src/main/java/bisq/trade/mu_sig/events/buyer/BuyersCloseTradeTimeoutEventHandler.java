...
@Slf4j
public final class BuyersCloseTradeTimeoutEventHandler extends MuSigTradeEventHandler<MuSigTrade, BuyersCloseTradeTimeoutEvent> {
    private CloseTradeResponse myCloseTradeResponse;

    public BuyersCloseTradeTimeoutEventHandler(ServiceProvider serviceProvider, MuSigTrade model) {
        super(serviceProvider, model);
    }

    @Override
    public void process(BuyersCloseTradeTimeoutEvent event) {
