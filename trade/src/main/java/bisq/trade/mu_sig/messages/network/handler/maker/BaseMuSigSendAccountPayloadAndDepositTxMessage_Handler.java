...
@Slf4j
public abstract class BaseMuSigSendAccountPayloadAndDepositTxMessage_Handler extends MuSigTradeMessageHandlerAsMessageSender<MuSigTrade, MuSigSendAccountPayloadAndDepositTxMessage> {
    private ByteArray depositTx;
    private AccountPayload peersAccountPayload;

    public BaseMuSigSendAccountPayloadAndDepositTxMessage_Handler(ServiceProvider serviceProvider, MuSigTrade model) {
    ...
    @Override
    protected void process(MuSigSendAccountPayloadAndDepositTxMessage message) {
    ...
    protected void sendMessage() {
        ...
        AccountPayload accountPayload = new F2FAccountPayload(
                ...
                "contact",
                "extraInfo");
        send(new MuSigSendAccountPayloadMessage(StringUtils.createUid(),
                trade.getId(),
