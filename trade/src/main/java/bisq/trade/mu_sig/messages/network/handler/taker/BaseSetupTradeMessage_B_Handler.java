...
@Slf4j
public abstract class BaseSetupTradeMessage_B_Handler extends MuSigTradeMessageHandlerAsMessageSender<MuSigTrade, SetupTradeMessage_B> {
    ...
    public BaseSetupTradeMessage_B_Handler(ServiceProvider serviceProvider, MuSigTrade model) {
    ...
    @Override
    protected void process(SetupTradeMessage_B message) {
    ...
    protected void sendMessage() {
        ...
        send(new SetupTradeMessage_C(StringUtils.createUid(),
                trade.getId(),
