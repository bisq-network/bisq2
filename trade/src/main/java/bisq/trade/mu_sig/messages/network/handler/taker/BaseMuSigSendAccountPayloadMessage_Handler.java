...
@Slf4j
public abstract class BaseMuSigSendAccountPayloadMessage_Handler extends MuSigTradeMessageHandler<MuSigTrade, MuSigSendAccountPayloadMessage> {
    private AccountPayload peersAccountPayload;

    public BaseMuSigSendAccountPayloadMessage_Handler(ServiceProvider serviceProvider, MuSigTrade model) {
    ...
    @Override
    protected void process(MuSigSendAccountPayloadMessage message) {
