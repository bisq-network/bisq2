...
public final class MuSigOpenTradeChatLogMessage extends MuSigTradeMessage {
    ...
    public MuSigOpenTradeChatLogMessage(String id,
                                        String tradeId,
    ...
    public static MuSigOpenTradeChatLogMessage fromProto(bisq.trade.protobuf.TradeMessage proto) {
        bisq.trade.protobuf.MuSigSetupTradeMessage_A muSigMessageProto = proto.getMuSigTradeMessage().getMuSigSetupTradeMessageA();
        return new MuSigOpenTradeChatLogMessage(
                proto.getId(),
                proto.getTradeId(),
