...
public class BisqEasyConfirmBtcSentMessage extends TradeMessage {
    ...
    protected bisq.trade.protobuf.TradeMessage toTradeMessageProto() {
        return getTradeMessageBuilder().setBisqEasyConfirmBtcSentMessage(
    ...
    public static BisqEasyConfirmBtcSentMessage fromProto(bisq.trade.protobuf.TradeMessage proto) {
        bisq.trade.protobuf.BisqEasyConfirmBtcSentMessage bisqEasyTakeOfferRequest = proto.getBisqEasyConfirmBtcSentMessage();
        return new BisqEasyConfirmBtcSentMessage(
                proto.getTradeId(),
                NetworkId.fromProto(proto.getSender()),
                bisqEasyTakeOfferRequest.getTxId(),
