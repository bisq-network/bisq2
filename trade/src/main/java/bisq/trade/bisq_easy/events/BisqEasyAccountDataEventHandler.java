...
public class BisqEasyAccountDataEventHandler extends SendTradeMessageHandler<BisqEasyTrade> {
    ...
    public void handle(Event event) {
        ...
        BisqEasyAccountDataMessage message = new BisqEasyAccountDataMessage(model.getId(), model.getMyIdentity().getNetworkId(), paymentAccountData);
        sendMessage(message, model.getMaker().getNetworkId(), model.getMyIdentity().getNodeIdAndKeyPair());
    }
}