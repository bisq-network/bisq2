...
@Slf4j
public abstract class BisqEasyTradeMessageHandler<T extends BisqEasyTrade, M extends TradeMessage> extends TradeMessageHandler<T, M> {
    protected final BisqEasyTradeService tradeService;

    protected BisqEasyTradeMessageHandler(ServiceProvider serviceProvider, T trade) {
