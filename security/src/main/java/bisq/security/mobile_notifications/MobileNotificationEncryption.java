...
/**
 * Utility class for encrypting mobile push notification payloads using ECIES
 * (Elliptic Curve Integrated Encryption Scheme).
 * <p>
 * The encryption uses the device's public key to encrypt the notification payload,
 * ensuring that only the device with the corresponding private key can decrypt it.
 */
@Slf4j
