...
public final class ConfidentialData implements NetworkProto {
    ...
    @Override
    public bisq.security.protobuf.ConfidentialData toProto(boolean ignoreAnnotation) {
        return buildProto(ignoreAnnotation);
    }

    @Override
    public bisq.security.protobuf.ConfidentialData.Builder getBuilder(boolean ignoreAnnotation) {
