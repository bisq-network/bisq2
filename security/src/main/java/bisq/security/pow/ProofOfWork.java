...
public final class ProofOfWork implements NetworkProto {
    ...
    @Override
    public bisq.security.protobuf.ProofOfWork toProto(boolean ignoreAnnotation) {
        return buildProto(ignoreAnnotation);
    }

    @Override
    public bisq.security.protobuf.ProofOfWork.Builder getBuilder(boolean ignoreAnnotation) {
