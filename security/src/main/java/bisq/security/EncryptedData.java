...
public final class EncryptedData implements PersistableProto {
    ...
    @Override
    public bisq.security.protobuf.EncryptedData toProto(boolean ignoreAnnotation) {
        return buildProto(ignoreAnnotation);
    }

    @Override
    public bisq.security.protobuf.EncryptedData.Builder getBuilder(boolean ignoreAnnotation) {
