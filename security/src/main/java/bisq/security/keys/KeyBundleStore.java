...
public final class KeyBundleStore implements PersistableStore<KeyBundleStore> {
    ...
    @Override
    public bisq.security.protobuf.KeyBundleStore toProto(boolean ignoreAnnotation) {
        return buildProto(ignoreAnnotation);
    }

    @Override
    public bisq.security.protobuf.KeyBundleStore.Builder getBuilder(boolean ignoreAnnotation) {
        return bisq.security.protobuf.KeyBundleStore.newBuilder()
                ...
                .putAllKeyBundleById(keyBundleById.entrySet().stream()
                        .collect(Collectors.toMap(Map.Entry::getKey,
                                entry -> entry.getValue().toProto(ignoreAnnotation))));
    }
