...
import bisq.http_api.access.pairing.qr.PairingQrCodeGenerator;
...
public class PairingService {
    ...
    public PairingService(Path appDataDirPath,
    ...
    private void writePairingQrCodeToDataDir(String pairingQrCode) {
        try {
            ...
            log.error("Error writing pairing QR code to file", e);
        }
    }
}
