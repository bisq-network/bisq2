...
public enum Permission implements ProtoEnum {
    ...
    @Override
    public bisq.http_api.protobuf.Permission toProtoEnum() {
        return bisq.http_api.protobuf.Permission.valueOf(getProtobufEnumPrefix() + name());
    }

    public static Permission fromProto(bisq.http_api.protobuf.Permission proto) throws UnresolvableProtobufEnumException {
