...
package bisq.http_api.access.permissions;
...
public class PermissionSet implements PersistableProto {
    ...
    @Override
    public bisq.http_api.protobuf.PermissionSet toProto(boolean serializeForHash) {
        return resolveProto(serializeForHash);
    }

    @Override
    public bisq.http_api.protobuf.PermissionSet.Builder getBuilder(boolean serializeForHash) {
        return bisq.http_api.protobuf.PermissionSet.newBuilder()
                .addAllPermissions(permissions.stream().map(Permission::toProtoEnum).toList());
    }

    public static PermissionSet fromProto(bisq.http_api.protobuf.PermissionSet proto) {
