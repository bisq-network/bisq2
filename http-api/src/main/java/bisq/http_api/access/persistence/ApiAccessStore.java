...
package bisq.http_api.access.persistence;

import bisq.http_api.access.identity.ClientProfile;
import bisq.http_api.access.permissions.Permission;
import bisq.http_api.access.permissions.PermissionSet;
...
final class ApiAccessStore implements PersistableStore<ApiAccessStore> {
    ...
    @Override
    public bisq.http_api.protobuf.ApiAccessStore.Builder getBuilder(boolean serializeForHash) {
        return bisq.http_api.protobuf.ApiAccessStore.newBuilder()
    ...
    @Override
    public bisq.http_api.protobuf.ApiAccessStore toProto(boolean serializeForHash) {
        return resolveProto(serializeForHash);
    }

    public static ApiAccessStore fromProto(bisq.http_api.protobuf.ApiAccessStore proto) {
    ...
    public ProtoResolver<PersistableStore<?>> getResolver() {
        return any -> {
            try {
                return fromProto(any.unpack(bisq.http_api.protobuf.ApiAccessStore.class));
