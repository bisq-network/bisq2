 ...
 */
@Getter
@Schema(description = "Request to unregister a device from push notifications")
public class UnregisterDeviceRequest {
    ...
    @Schema(description = "APNs device token to remove", required = true, example = "abc123def456...")
    private final String deviceToken;

    @JsonCreator
    public UnregisterDeviceRequest(@JsonProperty("userProfileId") String userProfileId,
