...
public class RestApiResourceConfig extends BaseRestApiResourceConfig {
    public RestApiResourceConfig(CommonApiConfig config,
        ...
        register(TradeChatRestApi.class);
        ...
        register(UserDefinedFiatAccountsRestApi.class);
        ...
        register(new AbstractBinder() {
            ...
            protected void configure() {
                ...
                bind(tradeChatRestApi).to(TradeChatRestApi.class);
                ...
                bind(userDefinedFiatAccountsRestApi).to(UserDefinedFiatAccountsRestApi.class);
