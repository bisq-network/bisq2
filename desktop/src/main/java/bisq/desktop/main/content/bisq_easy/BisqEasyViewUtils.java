...
public class BisqEasyViewUtils {
    ...
    public static Triple<MultiStyleLabelPane, HBox, VBox> getContainerWithMultiStyleLabel(String headline, Node content) {
        MultiStyleLabelPane headlineLabel = new MultiStyleLabelPane(headline);
        headlineLabel.getStyleClass().add("bisq-easy-container-headline");
        //HBox.setMargin(headlineLabel, new Insets(15, 30, 15, 30));
