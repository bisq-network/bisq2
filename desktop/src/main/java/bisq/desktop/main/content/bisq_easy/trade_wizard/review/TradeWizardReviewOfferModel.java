...
class TradeWizardReviewOfferModel implements Model {
    ...
    private final ObservableList<TradeWizardReviewOfferView.ListItem> matchingOffers = FXCollections.observableArrayList();
    private final SortedList<TradeWizardReviewOfferView.ListItem> sortedList = new SortedList<>(matchingOffers);
