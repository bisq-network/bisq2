...
public class NetworkInfoModel implements Model {
    ...
    public NetworkInfoModel(ServiceProvider serviceProvider) {
        ...
        clearNetDisabled.set(!networkService.isTransportTypeSupported(Type.CLEAR));
        torDisabled.set(!networkService.isTransportTypeSupported(Type.TOR));
        i2pDisabled.set(!networkService.isTransportTypeSupported(Type.I2P));
