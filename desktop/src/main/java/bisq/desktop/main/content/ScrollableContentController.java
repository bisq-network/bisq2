...
@Slf4j
public class ScrollableContentController extends NavigationController {
    private final ServiceProvider serviceProvider;
    @Getter
    private final ScrollableContentModel model;
    @Getter
    private final ScrollableContentView view;

    public ScrollableContentController(ServiceProvider serviceProvider) {
        super(NavigationTarget.SCROLLABLE_CONTENT);

        this.serviceProvider = serviceProvider;
        model = new ScrollableContentModel(serviceProvider.getWalletService().isPresent());
        view = new ScrollableContentView(model, this);
    }
