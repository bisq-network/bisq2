...
public class BondedReputationTab1View extends View<VBox, BondedReputationTab1Model, BondedReputationTab1Controller> {
    ...
    public BondedReputationTab1View(BondedReputationTab1Model model,
        ...
        Label headline = new Label(Res.get("user.reputation.bond.infoHeadline"));
        headline.getStyleClass().add("bisq-text-headline-2");

        Text infoLabelText = new Text(Res.get("user.reputation.bond.info"));
        ...
        Text info2LabelText = new Text(Res.get("user.reputation.bond.info2"));
