...
public class BasicPopup extends BasicOverlay<BasicPopup> {
    ...
    private static class Manager {
        private static final Queue<BasicPopup> popups = new LinkedBlockingQueue<>(5);
        private static BasicPopup displayedPopup;

        private static void queueForDisplay(BasicPopup popup) {
        ...
        private static void onHidden(BasicPopup popup) {
