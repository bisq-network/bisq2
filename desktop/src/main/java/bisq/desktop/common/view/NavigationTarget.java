...
public enum NavigationTarget {
    ...
    LEARN(CONTENT),
    ACADEMY_OVERVIEW(LEARN),
    BISQ_ACADEMY(LEARN),
    BITCOIN_ACADEMY(LEARN),
    SECURITY_ACADEMY(LEARN),
    PRIVACY_ACADEMY(LEARN),
    WALLETS_ACADEMY(LEARN),
    OPEN_SOURCE_ACADEMY(LEARN),
    
    CONNECT(CONTENT),

    TRADE(CONTENT, false),
    TRADE_OVERVIEW_LIST(TRADE),
