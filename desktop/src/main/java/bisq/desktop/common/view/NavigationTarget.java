...
public enum NavigationTarget {
    ...
    MULTI_SIG_OPEN_OFFERS(MULTISIG),
    MULTI_SIG_PENDING_TRADES(MULTISIG),
    MULTI_SIG_CLOSED_TRADES(MULTISIG),
    MULTI_SIG_OFFER_BOOK(MULTISIG),
    MULTI_SIG_CREATE_OFFER(MULTISIG),
    MULTI_SIG_TAKE_OFFER(MULTISIG, false),
    ...
    REGISTER_SEED_NODE(ROLES_TABS),
    REGISTER_ORACLE_NODE(ROLES_TABS),
    REGISTER_EXPLORER_NODE(ROLES_TABS),
    REGISTER_MARKET_PRICE_NODE(ROLES_TABS),
