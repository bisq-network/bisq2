...
public enum NavigationTarget {
    ...
    SECURITY_ACADEMY(SCROLLABLE_CONTENT, false),
    PRIVACY_ACADEMY(SCROLLABLE_CONTENT, false),
    ...
    LIQUID_MULTISIG(SCROLLABLE_CONTENT, false),
    LIGHTNING_FIAT(SCROLLABLE_CONTENT, false),
    LIQUID_SWAP(SCROLLABLE_CONTENT, false),
    BSQ_SWAP(SCROLLABLE_CONTENT, false),
    LIGHTNING_ESCROW(SCROLLABLE_CONTENT, false),
    MONERO_SWAP(SCROLLABLE_CONTENT, false),

    SETTINGS(SCROLLABLE_CONTENT),
    PREFERENCES(SETTINGS),
    NETWORK_INFO(SETTINGS),
    ABOUT(SETTINGS),

    USER(SCROLLABLE_CONTENT),
    USER_PROFILE(USER),
    PASSWORD(USER),
    ...
    AUTHORIZED_ROLE(SCROLLABLE_CONTENT),
