...
public enum NavigationTarget {
    ...
    BISQ_EASY_ONBOARDING(ONBOARDING, false),
    BISQ_EASY_ONBOARDING_TAB1(BISQ_EASY_ONBOARDING, false),
    BISQ_EASY_ONBOARDING_TAB2(BISQ_EASY_ONBOARDING, false),
    BISQ_EASY_ONBOARDING_TAB3(BISQ_EASY_ONBOARDING, false),

    CREATE_PROFILE(ONBOARDING, false),
    
    ONBOARDING_DIRECTION(ONBOARDING, false),
    ONBOARDING_MARKET(ONBOARDING, false),
    ONBOARDING_AMOUNT(ONBOARDING, false),
    ONBOARDING_PAYMENT_METHOD(ONBOARDING, false),
    ONBOARDING_OFFER_COMPLETED(ONBOARDING, false),
    ONBOARDING_OFFER_PUBLISHED(ONBOARDING, false),
