...
public enum NavigationTarget {
    ...
    CREATE_OFFER_SETTLEMENT_METHOD(CREATE_OFFER, false),
    ...
    TRADE_ASSISTANT(BISQ_EASY_CHAT, false),
    TRADE_ASSISTANT_OFFER(TRADE_ASSISTANT, false),
    TRADE_ASSISTANT_NEGOTIATION(TRADE_ASSISTANT, false),
    TRADE_ASSISTANT_TRADE(TRADE_ASSISTANT, false),
