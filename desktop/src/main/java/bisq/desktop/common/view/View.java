        ...
        sceneChangeListener = (ov, oldValue, newScene) -> {
            if (oldValue == null && newScene != null) {
                if (newScene.getWindow() != null) {
                    ...
                    UIThread.runLater(() -> root.sceneProperty().removeListener(View.this.sceneChangeListener));
                } else {
                    ...
                    windowChangeListener = (observable, oldValue1, newWindow) -> {
                        ...
                        onViewAttachedPrivate();
                        UIThread.runLater(() -> newScene.windowProperty().removeListener(View.this.windowChangeListener));
                    };
