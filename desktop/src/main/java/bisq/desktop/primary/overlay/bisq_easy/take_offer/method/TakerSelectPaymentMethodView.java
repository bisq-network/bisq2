...
@Slf4j
public class TakerSelectPaymentMethodView extends View<VBox, TakerSelectPaymentMethodModel, TakerSelectPaymentMethodController> {
    ...
    public TakerSelectPaymentMethodView(TakerSelectPaymentMethodModel model, TakerSelectPaymentMethodController controller) {
