...
@Getter
@Setter
public class GlobalOpenOffersModel implements Model {
    private final NetworkService networkService;
    private final KeyPairService keyPairService;
    final MarketPriceService marketPriceService;

    // listItems is bound to set from OpenOfferService
    final ObservableList<GlobalOpenOfferListItem> listItems = FXCollections.observableArrayList();
    final FilteredList<GlobalOpenOfferListItem> filteredItems = new FilteredList<>(listItems);
    final SortedList<GlobalOpenOfferListItem> sortedItems = new SortedList<>(filteredItems);
    ...
    public GlobalOpenOffersModel(DefaultApplicationService applicationService) {
