...
@Slf4j
public class CreateOfferView extends View<VBox, CreateOfferModel, CreateOfferControllerOld> {
    private final BisqButton back, next;

    public CreateOfferView(CreateOfferModel model, CreateOfferControllerOld controller) {
