...
package bisq.desktop.primary.main.content.trade.bisqEasy.chat.help.tab1;
...
@Slf4j
public class BisqEasyHelpTab1View extends View<VBox, BisqEasyHelpTab1Model, BisqEasyHelpTab1Controller> {
    private final Button nextButton;
    private final Hyperlink learnMore;
    private final Text content;
    private Subscription widthPin;

    public BisqEasyHelpTab1View(BisqEasyHelpTab1Model model,
                                BisqEasyHelpTab1Controller controller) {
