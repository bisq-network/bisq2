...
public class SellerState4 extends BaseState {
    ...
    public SellerState4(DefaultApplicationService applicationService, BisqEasyOffer bisqEasyOffer, UserIdentity myUserIdentity) {
    ...
    public static class View extends BaseState.View<Model, Controller> {
        ...
        private View(Model model, Controller controller) {
            ...
            button = new Button(Res.get("bisqEasy.tradeState.info.seller.phase4.buttonText"));
