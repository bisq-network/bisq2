...
@Slf4j
public class TradeInfoTab2View extends View<VBox, TradeInfoTab2Model, TradeInfoTab2Controller> {
    private final Button backButton, nextButton;
    private final Hyperlink learnMore;
    private final Text content;
    private Subscription widthPin;

    public TradeInfoTab2View(TradeInfoTab2Model model,
                             TradeInfoTab2Controller controller) {
        super(new VBox(), model, controller);

        root.setSpacing(20);
        root.setAlignment(Pos.TOP_LEFT);

        Label headline = new Label(Res.get("tradeInfo.tab2.headline"));
        headline.getStyleClass().add("bisq-text-headline-2");

        content = new Text(Res.get("tradeInfo.tab2.content"));
