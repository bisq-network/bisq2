...
public class PaymentAccountsView extends View<HBox, PaymentAccountsModel, PaymentAccountsController> {
    ...
    private final AutoCompleteComboBox<BisqEasyPaymentAccount> accountSelection;
    ...
    public PaymentAccountsView(PaymentAccountsModel model, PaymentAccountsController controller) {
        ...
        createButton = new Button(Res.get("settings.paymentAccounts.createAccount"));
        createButton.getStyleClass().addAll("outlined-button");

        accountSelection = new AutoCompleteComboBox<>(model.getSortedAccounts(), Res.get("settings.paymentAccounts.selectAccount"));
        ...
        accountData = addTextArea(Res.get("settings.paymentAccounts.accountData"), Res.get("settings.paymentAccounts.createAccount.accountData.prompt"));
        ...
        deletedButton = new Button(Res.get("settings.paymentAccounts.deleteAccount"));
