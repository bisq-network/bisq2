...
@Slf4j
public class UserProfileViewOld extends View<VBox, UserProfileModelOld, UserProfileControllerOld> {
    private final Button showCreateUserProfileButton;
    private final Pane channelAdmin;
    private final Pane createUserProfile;

    public UserProfileViewOld(UserProfileModelOld model,
                              UserProfileControllerOld controller,
