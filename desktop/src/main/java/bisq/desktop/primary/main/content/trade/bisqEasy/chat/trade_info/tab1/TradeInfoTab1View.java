...
package bisq.desktop.primary.main.content.trade.bisqEasy.chat.trade_info.tab1;
...
@Slf4j
public class TradeInfoTab1View extends View<VBox, TradeInfoTab1Model, TradeInfoTab1Controller> {
    private final Button nextButton;
    private final Hyperlink learnMore;
    private final Text content;
    private Subscription widthPin;

    public TradeInfoTab1View(TradeInfoTab1Model model,
                             TradeInfoTab1Controller controller) {
        ...
        Label headline = new Label(Res.get("tradeInfo.tab1.headline"));
        headline.getStyleClass().add("bisq-text-headline-2");

        content = new Text(Res.get("tradeInfo.tab1.content"));
