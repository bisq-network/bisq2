...
package bisq.desktop.primary.main.content.trade_apps.overview.grid;

import bisq.desktop.common.Icons;
import bisq.desktop.common.Layout;
import bisq.desktop.common.utils.ImageUtil;
import bisq.desktop.components.controls.BisqTooltip;
import bisq.desktop.primary.main.content.trade_apps.overview.ProtocolListItem;
import bisq.desktop.primary.main.content.trade_apps.overview.TradeAppsAttributes;
import bisq.desktop.primary.main.content.trade_apps.overview.TradeOverviewView;
...
public class TradeOverviewGridView extends TradeOverviewView<GridPane, TradeOverviewGridModel, TradeOverviewGridController> {
    ...
    private Pane getProtocolBox(ProtocolListItem protocol) {
        ...
        if (protocol.getSwapProtocolType() != TradeAppsAttributes.Type.BISQ_EASY) {
