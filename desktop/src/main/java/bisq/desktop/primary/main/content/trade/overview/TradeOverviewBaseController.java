...
public abstract class TradeOverviewBaseController<M extends TradeOverviewBaseModel> implements Controller {
    ...
    public TradeOverviewBaseController(M model) {
        ...
        model.getListItems().setAll(
                ...
                new ProtocolListItem(SwapProtocol.Type.LN_X,
                        NavigationTarget.LN_X,
                        Res.get("trade.protocols.basic.info.LN_X"),
                        Res.get("trade.protocols.markets.LN_X"),
                        Res.get("trade.protocols.markets.info.LN_X"),
                        Res.get("trade.protocols.security.info.LN_X"),
                        new Pair<>(10000L, 700000L),
                        Res.get("trade.protocols.privacy.info.LN_X"),
                        Res.get("trade.protocols.convenience.info.LN_X"),
                        Res.get("trade.protocols.costs.info.LN_X"),
                        Res.get("trade.protocols.speed.info.LN_X"),
                        "Q4/22",
                        "protocol-lightning"
                )
        );
