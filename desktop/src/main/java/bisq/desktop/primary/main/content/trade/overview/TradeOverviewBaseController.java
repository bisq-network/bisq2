...
public abstract class TradeOverviewBaseController<M extends TradeOverviewBaseModel> implements Controller {
    ...
    public TradeOverviewBaseController(M model) {
        ...
        model.getListItems().setAll(
                new ProtocolListItem(TradeProtocolDescription.Type.BISQ_EASY,
                ...
                new ProtocolListItem(TradeProtocolDescription.Type.BISQ_MULTISIG,
                ...
                new ProtocolListItem(TradeProtocolDescription.Type.LIQUID_SWAP,
                ...
                new ProtocolListItem(TradeProtocolDescription.Type.BSQ_SWAP,
