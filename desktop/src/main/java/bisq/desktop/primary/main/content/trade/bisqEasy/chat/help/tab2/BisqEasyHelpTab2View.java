...
@Slf4j
public class BisqEasyHelpTab2View extends View<VBox, BisqEasyHelpTab2Model, BisqEasyHelpTab2Controller> {
    private final Button backButton, nextButton;
    private final Hyperlink learnMore;
    private final Text content;
    private Subscription widthPin;

    public BisqEasyHelpTab2View(BisqEasyHelpTab2Model model,
                                BisqEasyHelpTab2Controller controller) {
