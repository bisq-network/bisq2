...
@Slf4j
public class OfferbookView extends View<VBox, OfferbookModel, OfferbookControllerOld> {
    ...
    public OfferbookView(OfferbookModel model, OfferbookControllerOld controller) {
