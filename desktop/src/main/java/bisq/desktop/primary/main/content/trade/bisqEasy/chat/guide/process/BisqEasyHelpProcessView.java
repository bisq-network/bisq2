...
@Slf4j
public class BisqEasyHelpProcessView extends View<VBox, BisqEasyHelpProcessModel, BisqEasyHelpProcessController> {
    private final Button backButton, nextButton;
    private final Hyperlink learnMore;
    private final Text content;
    private Subscription widthPin;

    public BisqEasyHelpProcessView(BisqEasyHelpProcessModel model,
                                   BisqEasyHelpProcessController controller) {
