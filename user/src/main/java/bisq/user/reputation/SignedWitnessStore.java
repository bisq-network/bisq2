...
public final class SignedWitnessStore implements PersistableStore<SignedWitnessStore> {
    ...
    @Override
    public bisq.user.protobuf.SignedWitnessStore.Builder getBuilder(boolean ignoreAnnotation) {
    ...
    @Override
    public bisq.user.protobuf.SignedWitnessStore toProto(boolean ignoreAnnotation) {
