...
public final class ProfileAgeStore implements PersistableStore<ProfileAgeStore> {
    ...
    @Override
    public bisq.user.protobuf.ProfileAgeStore.Builder getBuilder(boolean ignoreAnnotation) {
    ...
    @Override
    public bisq.user.protobuf.ProfileAgeStore toProto(boolean ignoreAnnotation) {
