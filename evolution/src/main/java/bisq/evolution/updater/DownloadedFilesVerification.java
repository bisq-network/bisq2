...
public class DownloadedFilesVerification {
    public static void verify(String directory,
        ...
        DownloadedFilesVerification.checkSignatureWithKeyFromWebpage(directory, signingKeyId, signingKey, sigFile, dataFile);

        if (!ignoreSigningKeyInResourcesCheck) {
            DownloadedFilesVerification.checkSignatureWithKeyInResources(directory, signingKeyId, signingKey, sigFile, dataFile);
        }
